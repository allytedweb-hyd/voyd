...
// import QuestionaireForms from "../Components/Questionnair/QuestionaireForms";
...
import RouteChangePrompt from './RouteChangePrompt';
...
const Questionnaire = () => {
  ...
  const getAllItems = (elementData) => {
    ...
    console.log(
      `values are ${JSON.stringify(values)} and values} tabs are ${values.tabs
  ...
  const submitFormBtn = async (data) => {
    if (isSubmitting) return;
  ...
  return (
    <>
      ...
      <RouteChangePrompt when={hasUnsavedChanges} />
              ...
              >
                <div className="filter-div mb-2 p-4">
                  <div className="d-flex mb-4">
                    <div>
                      <h6 className="fil-txt text-dark m-0">Filters</h6>
                    </div>
                ...
                <div className="progress-line">
                  ...
                  <div className="col-md-12">
                    <button className="sub-qt-btn" type="submit" disabled={isSubmitting}>
                      SUBMIT QUOTE
                    </button>
                  </div>
                </div>
              ...
              {!loading && (
                <>
                  <Tabs>
                    {noOfTabs.length > 0 && (
                      <TabList
                        className="quote-draft quatTabs"
                        id="interiorTabs"
                      >
                    ...
                    {noOfTabs != undefined && interiorEleData.length > 0 ? (
                      noOfTabs.map((each) => (
                        <TabPanel id={`interiorTabPanel${each}`}>
        ...
        <div className="container-fluid ">
          <div className="balance row budget-management-nav">
            ...
            <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 budget-management-block amount">
              ...
              <div className="values-container">
                <p> {formatCurrency(totalProjectBudget)}/-</p>
                <p> {formatCurrency(utilizedBudget)}/-</p>
                    ...
                    >
                      ...
                      {interiorEle === "Data not found" ? (
                        ...
                        >
                          <option value="">Select</option>
                          {interiorEle.map((eachEle) => (
                            <option value={eachEle?.element_id}>
                              {eachEle?.element_name}
                            </option>
                          ))}
                        </select>
