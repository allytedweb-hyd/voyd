...
<div class="page-wrapper">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-category.php">Add Category</li></a>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="">
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Category</h3>
                        <div class="row" style="padding: 0px 10px;">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from category where status=1 ORDER BY category_id DESC");
                                        $i = 1;
    ...
    <div class="tooltip-text" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        <?= htmlspecialchars(mb_strimwidth($cleanDesc, 0, 50, '...')) ?> 
                                                ...
                                                <td><img class="imagedata" src='Uploads/category/<?php echo $fetch['category_image']; ?>' />
                                                </td>
                                                <td>
    ...
    <div class="tooltip-text" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        <?= htmlspecialchars(mb_strimwidth($cleanDesc, 0, 50, '...')) ?> 
                                                ...
                                                <td><img class="imagedata" src='Uploads/category/<?php echo $fetch['banner_image']; ?>' />
                                                </td>
                                                <td>
                                                    

                                                <?php
        $rawDesc = $fetch['alt_text2'] ?? '';
        $plainDesc = strip_tags($rawDesc);                       
        $cleanDesc = str_replace('&nbsp;', ' ', $plainDesc);    
        $escapedDesc = htmlspecialchars($cleanDesc); 
    ?>
    <div class="tooltip-text" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        <?= htmlspecialchars(mb_strimwidth($cleanDesc, 0, 50, '...')) ?> 
                                                ...
                                                <td class="actionbuttons"><a class="iedit" href="./edit-category.php?id=<?php echo $fetch['category_id']; ?>"><i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-category.php?id=<?php echo $fetch['category_id']; ?>"><i class='bx bx-trash' name="deleteProject"></i></a>
                                                </td>
