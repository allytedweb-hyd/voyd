            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./manufacturerSubCategory.php">View Sub Category</li></a>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        ...
                        <?php
                        $query = mysqli_query($conn, "select * from manufacturer_subCategory where 
                        mSubcategory_id='" . $_GET['id'] . "'");
                        ...
                        <form class="row form_new" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select" id="producType" name="productType" size="1">
                                    <!-- <?php
...
<?php
        ...
        <?php
        // Select product types excluding the currently selected one
        ...
        ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select" id="category" name="category" size="1">
                                    <!-- <?php
                                    $mcategoryid = mysqli_query($conn, "select * from manufacturer_category where mcategory_id='" . $fetch['select_category'] . "'");
...
<?php
        ...
        <?php
        // Select categories excluding the currently selected one
        $query = mysqli_query($conn, "SELECT * FROM manufacturer_category WHERE status=1 AND mcategory_id != '" . $fetch['select_category'] . "'");
        while ($fetchCat = mysqli_fetch_array($query)) {
        ?>
        ...
        ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="subcategory" id="subcategory" value="<?php echo $fetch['sub_category'] ?>">
                                <input type="hidden" name="subcategoryId" value="<?php echo $fetch['mSubcategory_id'] ?>" />
                                <p id="errText" class="error-text"></p>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <button type="button" id="add-subcategory" class="btn btn-primary px-4 submit">Submit</button>
                                    <button name="submit_form" type="submit" id="submit-subcategory" class="btn btn-primary px-4 submit d-none">Submit</button>                                </div>
                            </div>
                        </form>
                    </div>
                </div>
