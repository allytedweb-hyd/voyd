            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-producttypemaster.php">Add Product Type </li></a>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="row" style="padding: 0px 10px;">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from product_type_master where status=1 ORDER BY product_type_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="actionbuttons"><a class="iedit" href="./edit-producttypemaster.php?id=<?php echo $fetch['product_type_id']; ?>"><i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-producttypemaster.php?id=<?php echo $fetch['product_type_id']; ?>"><i class='bx bx-trash' name="deleteProject"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
