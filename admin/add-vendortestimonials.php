...
if(isset($_POST['submit_form'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        $targetPath = 'Uploads/vendortestimonials/' . $filename;
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./google_reviews.php">Vendor Testimonials
                        </li></a>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Add Vendor Testimonials</h3>
                        <form class="row form_new" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="testimonial_name" id="testimonial_name" value="<?php echo isset($_POST['testimonial_name']) ? htmlspecialchars($_POST['testimonial_name']) : ''; ?>">
                                <p id="errText" class="error-text"></p>
                            </div>
...
<?php if (!empty($_POST['oldImage'])): ?>
    <div style="margin-top: 2px;">
        <img src="Uploads/vendortestimonials/<?php echo htmlspecialchars($_POST['oldImage']); ?>" alt="Uploaded Image" width="80">
    </div>
<?php endif; ?>
