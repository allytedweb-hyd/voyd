            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-propertyType.php">Add Property Type</li></a>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="">
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Property Type</h3>
                                ...
                                <table class="table table-striped table-bordered" id="example2">
                                    <thead>
                                        <tr class="tableheadingrow">
                                            ...
                                            <th scope="col">Enter Property Type</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from property_type where status=1 ORDER BY propertyType_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="actionbuttons"><a class="iedit" href="./edit-propertyType.php?id=<?php echo $fetch['propertyType_id']; ?>"><i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-propertyType.php?id=<?php echo $fetch['propertyType_id']; ?>"><i class='bx bx-trash' name="deleteProject"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
