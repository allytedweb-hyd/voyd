...
<div class="page-wrapper">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-chooseUs.php">Add Why Choose Us</li></a>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h3 class="mb-4 text-center htext">View Why Choose Us</h3>
                        <div class="row">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "SELECT * FROM why_chooseUs where status=1 ORDER BY choose_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $fetch['choose_title']; ?></td>
                                                <td><img class="imagedata" src='Uploads/whychooseUs/<?php echo $fetch['choose_image']; ?>' /></td>
    ...
    <div class="tooltip-text" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        <?= htmlspecialchars(mb_strimwidth($cleanDesc, 0, 50, '...')) ?> 
                                                ...
                                                <td class="actionbuttons"><a class="iedit" href="./edit-chooseUs.php?id=<?php echo $fetch['choose_id']; ?>"> <i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-chooseUs.php?id=<?php echo $fetch['choose_id']; ?>"><i class='bx bx-trash' name="deleteProject"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
