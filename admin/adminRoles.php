...
<div class="page-wrapper">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-adminRoles.php">Add Role
                        </li></a>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Roles</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sel = mysqli_query($conn, "SELECT * FROM admin_roles WHERE status=1 ORDER BY role_id DESC");
                                        $i = 1;
    ...
    ?>
    <div class="tooltip-text" style="max-width: 500px !important;" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        <?= htmlspecialchars(mb_strimwidth($cleanDesc, 0, 200, '...')) ?> 
    </div>
                                        
                                        </td>
                                            <!-- <td><?php echo date('d-m-Y', strtotime($fetch['current_date'])) ?></td> -->
                                            <td><?php echo $_SESSION['Adminname'] ?></td>
                                            <td><?php echo date('d-m-Y', strtotime($fetch['updated_date'])) ?></td>
                                           
                                            <td class="actionbuttons" >
                                                <!-- <a class="iedit"
                                                    href="./edit-adminRole.php?id=<?php echo $fetch['role_id']; ?>"><i
                                                        class='bx bx-edit'></i></a> -->
                                                <a class="idelete"
                                                    href="./deleteAdminRole.php?id=<?php echo $fetch['role_id']; ?>"><i
