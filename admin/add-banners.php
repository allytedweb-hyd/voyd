            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./manage-banners.php">View
                                Banners</li>
                        </a>
                    </ol>
                </nav>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Add Banners</h3>
                        <form class="row form_new" id="submitForm" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="title" id="Bannertitle" value="<?php echo isset($_POST['title']) ? htmlspecialchars($_POST['title']) : ''; ?>">
...
<?php if (!empty($_POST['oldImage'])): ?>
    <div style="margin-top: 2px;">
        <img src="Uploads/banners/<?php echo htmlspecialchars($_POST['oldImage']); ?>" alt="Uploaded Image" width="80">
    </div>
<?php endif; ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="bdesc" name="description"><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                                <p id="errText" class="error-text"></p>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="Odesc" name="offer_description"><?php echo isset($_POST['offer_description']) ? htmlspecialchars($_POST['offer_description']) : ''; ?></textarea>
                                <p id="errText" class="error-text"></p>
                            </div>

                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="button" id="add-banner"
                                        class="btn btn-primary px-4 submit">Submit</button>
                                    <button name="submit_form" type="submit" id="submit-banner"
...
$(document).ready(function () {
    ...
    capitalizeFirstLetter("Bannertitle");
