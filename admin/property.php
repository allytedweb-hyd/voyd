            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-property.php">Add Property</li></a>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="">
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Property</h3>
                        <div class="row" style="padding: 0px 10px;">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from property where status=1 ORDER BY property_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $fetch['enter_property']; ?></td>
                                                <td><?php echo $fetch['updated_by']; ?></td>
                                                <td><?php echo $fetch['updated_At']; ?></td>
                                                <td class="actionbuttons"><a class="iedit" href="./edit-property.php?id=<?php echo $fetch['property_id']; ?>"><i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-property.php?id=<?php echo $fetch['property_id']; ?>"><i class='bx bx-trash' name="deleteProject"></i></a>
                                                </td>
