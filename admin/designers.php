            ...
            <div class="">
                ...
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Designers</h3>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="example2">
                                ...
                                <tbody>
                                <?php
                                   $sel = mysqli_query($conn, "select * from designers where status=1 ORDER BY designer_id DESC");
                                      $i=1;
                                   ...
                                   <td class="email-cell" ><?php echo $fetch['email']; ?></td>
                                    ...
                                    <td><img class="imagedata"  src='Uploads/designers/<?php echo $fetch['documents']; ?>' /></td>
                                  
                              
                                        <td class="actionbuttons">
                                        <a class="idelete" href="./delete-designer.php?id=<?php echo $fetch['designer_id']; ?>"><i class='bx bx-trash' name="deleteCustomer"></i></a>
                                        </td>
