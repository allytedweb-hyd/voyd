...
if (isset($_POST['submit_form'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        $targetPath = 'Uploads/shopbanners/' . $filename;
...
<?php if (!empty($_POST['oldImage'])): ?>
    <div style="margin-top: 2px;">
        <img src="Uploads/shopbanners/<?php echo htmlspecialchars($_POST['oldImage']); ?>" alt="Uploaded Image" width="80">
    </div>
<?php endif; ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="alttext" id="banneralttext" value="<?php echo isset($_POST['alttext']) ? htmlspecialchars($_POST['alttext']) : ''; ?>">
                                <p id="errText" class="error-text"></p>
                            </div>

                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="button" id="add-sbanner"
                                        class="btn btn-primary px-4 submit">Submit</button>
                                        <button name="submit_form" type="submit" id="submit-sbanner"
...
$(document).ready(function () {
    ...
    capitalizeFirstLetter("banneralttext");
