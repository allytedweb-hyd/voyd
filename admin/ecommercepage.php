...
const EcommerceFilter = () => {
  ...
  const handleApplyFilters = () => {
    ...
    // 🏠 Filter by room (if shopCat is "category")
    ...
    // 📦 Filter by product categories (if shopCat is "room")
                ...
                <div className="FilterOutr">
                  ...
                  <div className="col-md-10 carouselWrapper wi-hff">
                    ...
                    <div className="buttonOuter" ref={scrollRef}>
                      ...
                      {categories.length > 0 ? (
                        categories.map((each) => (
                          <button key={each.category_id}
                            className={`filterButtons2 ${selectedCategory === each.category_id ? 'active' : ''}`}
                            onClick={() => handleCategoryClick(each.category_id)}>
                            {each?.category_name}
                          </button>
                        ))
                      ) : (
                ...
                <div className="filter-div2">
                  ...
                  <div className="type-Div">
                    ...
                    <div className="search-tags-container">
                      ...
                      <div className="tags-wrapper">
                        {tags.map((tag, idx) => (
                          <div key={idx} className="tag" style={{ cursor: "pointer" }}>
                            <span
                              onClick={() => {
                                setSearchTerm(tag);
                                handleAddTag(tag);
                  ...
                  <div className="type-Div type-pgn">
                    ...
                    {shopCat === "room" && (
                      <div className="filter-section">
                        ...
                        >
                          <span className="filter-title">Product Categories</span>
                          <span className={`filter-arrow ${isRoomOpen ? "open" : ""}`}>
                            <TfiAngleDown className="ang-dn" />
                          </span>
                        </div>
                        ...
                        {isRoomOpen && (
                          <div className="filter-options-ct">
                            {(showAllCategories ? categories : categories.slice(0, initialLimit)).map(
                              (cat) => (
                                <div key={cat.category_id}>
                                  <label className="filter-option-ct">
                                    ...
                                    />
                                    <span className="custom-checkbox-ct"></span>
                                    <span className="option-label-ct bold">{cat.category_name}</span>
                                  </label>
                                </div>
                              )
                            )}
                    ...
                    {shopCat === "category" && (
                      <div className="filter-section">
                        ...
                        {isCategoryOpen && (
                          <div className="filter-options-ct">
                            {(showAllRooms ? rooms : rooms.slice(0, initialLimit)).map((room) => (
                                  ...
                                  <input
                                    ...
                                    onChange={() =>
                                      setSelectedRoom((prev) =>
                                        prev === room.section_id ? null : room.section_id
                                      )
                                    }
                                  />
                                  <span className="custom-checkbox-ct"></span>
                                  <span className="option-label-ct">{room.enter_section}</span>
                                </label>
                              </div>
                            ))}
                        ...
                        {[5, 10, 20, 30].map((discount) => (
                          <div key={discount}>
                            <label className="filter-option-ct">
                              ...
                              />
                              <span className="custom-checkbox-ct"></span>
                              <span className="option-label-ct bold">{discount} % Off</span>
                            </label>
                          </div>
                        ))}
                      </div>
                  ...
                  <div className="text-center">
                    <button className="sub-qt-btn-filters" type="submit" onClick={handleApplyFilters}>
                      APPLY FILTERS
                    </button>
                  </div>
                </div>
