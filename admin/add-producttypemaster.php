            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./producttypemaster.php">View Product Type 
                        </li></a>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Add Product Type </h3>
...
Select
                                ...
                                $querytestimonial = mysqli_query($conn, "SELECT * FROM product_master WHERE status=1");
                                  while ($fetchTestimonials = mysqli_fetch_array($querytestimonial)) {
                                    ?>
                                    <option 
                                    value="<?php echo $fetchTestimonials['product_master'] ?>" <?php echo (isset($_POST['product']) && $_POST['product'] == $fetchTestimonials['product_master']) ? 'selected' : ''; ?>
                                    >
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="producttype" id="producttype" value="<?= isset($_POST['producttype']) ? htmlspecialchars($_POST['producttype']) : '' ?>">
                                <p id="errText" class="error-text"></p>
                            </div>
