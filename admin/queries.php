...
<div class="page-wrapper">
            ...
            <div class="">
                ...
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Queries</h3>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="example2">
                                ...
                                <tbody>
                                <?php
                                   $sel = mysqli_query($conn, "select * from queries where status=1 ORDER BY contact_id DESC");
                                      $i=1;
                                    ...
                                    <td>
                                        <!-- <?php echo $fetch['contact_name']; ?> -->

                                               <div class="tooltip-text"
                                                 data-toggle="tooltip" data-placement="bottom"
                                                    title="<?php echo htmlspecialchars(ucwords(strip_tags($fetch['contact_name']))); ?>">
                                                    <?php echo htmlspecialchars(strip_tags($fetch['contact_name'])); ?>
                                                </div>
                                
                                </td>
                                    <td class="email-cell" ><?php echo $fetch['contact_email']; ?></td>
                                    <td><?php echo $fetch['contact_number']; ?></td>
                                    <td><?php echo $fetch['contact_subject']; ?></td>
                                    <td>

                                    

                                                <?php
        $rawDesc = $fetch['contact_message'] ?? '';
    ...
    <div class="tooltip-text" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        <?= htmlspecialchars(mb_strimwidth($cleanDesc, 0, 50, '...')) ?> 
                                        ...
                                        <a class="idelete" href="./delete-queries.php?id=<?php echo $fetch['contact_id']; ?>"><i class='bx bx-trash' name="deleteCustomer"></i></a>
                                        </td>
