...
<body class="body"
                                                            ...
                                                            <tr>
                                                                <td class="es-text-1448 es-m-p0b"
                                                                    ...
                                                                    <h4 class="es-override-size es-text-mobile-size-16"
                                                                        ...
                                                                        <strong>New Submission from Sales
                                                                            Form</strong>
                                                                    </h4>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="es-text-9182" style="padding:0;Margin:0">
                                                                    <p class="es-text-mobile-size-13 es-override-size"
                                                                        ...
                                                                        A customer submitted a request through your
                                                                        website. Please respond promptly to assist them
    ...
    $saveInfo = mysqli_query($conn, "INSERT INTO ongoing SET name='" . $name . "', phone='" . $mobileNo . "', email='" . $email . "', area='" . $area . "', city='" . $city . "', project='" . $projectType . "', project_details='" . $query . "',status=1");
    ...
    if ($send) {
        $stat = ['status' => true, 'message' => 'TThank you. Assistance will be provided shortly.'];
    }
} catch (Exception $e) {
