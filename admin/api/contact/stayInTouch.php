...
try {
    ...
    $mail->addAddress("sripriyaallyted1@gmail.com");               //Name is optional    
...
<body class="body"
                                                            ...
                                                            <tr>
                                                                <td class="es-text-1448 es-m-p0b"
                                                                    ...
                                                                    <h4 class="es-override-size es-text-mobile-size-16"
                                                                        ...
                                                                        <strong>New Get in Touch submission</strong>
                                                                    </h4>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="es-text-9182" style="padding:0;Margin:0">
                                                                    <p class="es-text-mobile-size-13 es-override-size"
                                                                        ...
                                                                        A new visitor has submitted the Get in Touch
                                                                        form on your website. Please review their
                                                                        details and connect with them at
    ...
    ';
    $mail->AltBody = 'Get in Touch';

    $insertInfo = mysqli_query($conn, "INSERT INTO get_started_with_us SET who_am_i='" . $role . "', name='" . $userName . "', mobile='" . $userMobile . "', status=1");
    if ($insertInfo) {

        $send = $mail->send();
        if ($send) {
            $stat = ['status' => true, 'response' => "Thank you! We'll contact you shortly"];
        }
    } else {
        $stat = ["status" => false, "response" => "Failed to store data in database",];
    }
} catch (Exception $e) {
