...
$cusMail = $data->email;
$cusMbl = $data->mobileNum;
// $Subject = $data->subject;
$cusQuery = $data->message;
...
try {
    ...
    //Recipients
    $mail->setFrom('mrinterior@mmworkspace.com', 'VOYD Interior');
...
<body class="body"
                                                            ...
                                                            <tr>
                                                                <td class="es-text-9182" style="padding:0;Margin:0">
                                                                    <p class="es-text-mobile-size-13 es-override-size"
                                                                        ...
                                                                        A new visitor has submitted the Contact
    ...
    $insertInfo = mysqli_query($conn, "INSERT INTO customer_support SET first_name='" . $firstName . "', last_name='" . $lastName . "', email='" . $cusMail . "', phone='" . $cusMbl . "', message='" . $cusQuery . "', query_through='contact', status=1");
    if ($insertInfo) {
        $send = $mail->send();
    }
