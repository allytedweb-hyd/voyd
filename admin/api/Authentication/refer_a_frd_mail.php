...
$getCustomerInfo = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM customer WHERE customer_id  = '$customerId' AND status = 1"));
$refferalCode = $getCustomerInfo['refferal_code'];

$referralByFirst = $getCustomerInfo['first_name'];
$referralByLast = $getCustomerInfo['last_name'];
$referralByEmail = $getCustomerInfo['customer_email'];
$referralByMobile = $getCustomerInfo['customer_mobile'];

// echo json_encode($getCustomerInfo);
// echo json_encode($refferalCode);
// exit();
...
$getRegInfo = mysqli_query($conn, "SELECT * FROM customer WHERE customer_email = '$email' AND status = 1");
$regCount = mysqli_num_rows($getRegInfo);

if ($regCount > 0) {
    http_response_code(400);
    echo json_encode(['status' => false, 'message' => "Oops! It looks like this email already belongs to a registered user. Please refer someone who hasn't signed up yet."]);
    exit();
}
...
<body class="body"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:0;Margin:0;width:560px">
                                                        <table cellpadding="0" cellspacing="0" role="presentation"
                                                            ...
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr>
                                                                <td align="center" class="es-text-1448 es-m-p0b"
                                                                    ...
                                                                    <h4 class="es-override-size es-text-mobile-size-16"
                                                                        ...
                                                                        <strong>Refer a Friend &amp; Earn ₹10,000
                                                                            Instantly!</strong>
                                                                    </h4>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-text-9182"
                                                                    ...
                                                                    <p class="es-text-mobile-size-13 es-override-size"
                                                                        ...
                                                                        We’ve got something exciting just for you!</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-text-6629"
                                                                    style="padding:0;Margin:0">
                                                                    <p class="es-text-mobile-size-13 es-override-size"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial,helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        When you&nbsp;<strong>refer a
                                                                            friend</strong>&nbsp;to register on our
                                                                        website, you both win!</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-text-4163"
                                                                    style="padding:0;Margin:0">
                                                                    <p class="es-override-size es-text-mobile-size-11"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        ✅ <strong>Your friend</strong>&nbsp;gets access
                                                                        to
                                                                        exclusive interior design services
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-text-1075"
                                                                    style="padding:0;Margin:0">
                                                                    <p class="es-override-size es-text-mobile-size-11"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        ✅ <strong>You</strong>&nbsp;get
                                                                        a&nbsp;<strong>₹10,000 bonus</strong>&nbsp;in
                                                                        your account once they sign up
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                    ...
                                    <tr></tr>
                                    <tr>
                                        <td align="left" class="es-m-p5t es-m-p15l"
                                            style="padding:0;Margin:0;padding-top:10px;padding-right:20px;padding-left:20px">
                                            <table cellpadding="0" cellspacing="0" align="left"
                                                class="es-left referaalCode" role="none"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                                                <tr>
                                                    <td align="left"
                                                        style="padding:0;Margin:0;padding-bottom:5px;width:560px">
                                                        <table cellpadding="0" cellspacing="0" role="presentation"
                                                            width="100%" bgcolor="#ebfee1"
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-radius:14px;background-color:#ebfee1">
                                                            <tr>
                                                                <td align="center" class="es-text-8219 es-m-p5t"
                                                                    style="padding:0;Margin:0;padding-top:15px">
                                                                    <h5 class="es-text-mobile-size-18 es-override-size es-m-txt-c"
                                                                        style="Margin:0;font-family:arial, helvetica
                                                                        neue, helvetica,
                                                                        sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#0e6844">
                                                                        <strong>Use the code</strong>
                                                                    </h5>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-m-p10t es-text-1179"
                                                                    style="padding:0;Margin:0;padding-top:20px">
                                                                    <h3 class="es-m-txt-c es-text-mobile-size-22 es-override-size"
                                                                        style="Margin:0;font-family:arial, helvetica
                                                                        neue, helvetica,
                                                                        sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:28px;font-style:normal;font-weight:normal;line-height:33.6px;color:#0e6844">
                                                                        <strong> ' . $refferalCode . '</strong>
                                                                    </h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    class="es-text-1507 es-m-p10t es-m-p0b"
                                                                    style="padding:0;Margin:0;padding-bottom:5px;padding-top:15px">
                                                                    <h6 class="es-text-mobile-size-14 es-override-size es-m-txt-c"
                                                                        style="Margin:0;font-family:arial, helvetica
                                                                        neue, helvetica,
                                                                        sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:16px;font-style:normal;font-weight:normal;line-height:19.2px;color:#0e6844">
                                                                        <strong>Hurry Up</strong>
                                                                    </h6>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-m-p15b"
                                                                    style="padding:0;Margin:0;padding-bottom:25px"><span
                                                                        class="es-button-border"
                                                                        style="border-style:solid;border-color:#2CB543;background:#0e6844;border-width:0px 0px 2px 0px;display:inline-block;border-radius:5px;width:auto"><a
                                                                            href="https://mrinterior.mmworkspace.com/signup?refferalCode=' . $refferalCode . '"
                                                                            target="_blank"
                                                                            class="es-button es-button-5783" style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:14px;padding:10px 20px 10px 20px;display:inline-block;background:#0e6844;border-radius:5px;font-family:arial,
                                                                            helvetica neue, helvetica,
                                                                            sans-serif;font-weight:normal;font-style:normal;line-height:16.8px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px
                                                                            solid #0e6844">Register
                                                                            now</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#384860;font-size:14px">
                                                                        : &nbsp; ' . $referralByFirst . ' ' . $referralByLast . '</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-text-1135"
                                                                    ...
                                                                    <p class="es-text-mobile-size-13 es-override-size es-m-txt-c"
                                                                        ...
                                                                        please add VOYD Interiors to your inbox. You are
                                                                        receiving this message because you recently
                                                                        visited our website or expressed interest in our
                                                                        services and newsletters. We look forward to
                                                                        sharing inspiring ideas, design updates, and
                                                                        exclusive offers with you regularly.</p>
                                                                    <p class="es-text-mobile-size-13 es-override-size es-m-txt-c"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;padding-top: 5px;">
                                                                        For more details, contact us at <a
                                                                            href="tel:+91  9115 833 833">+91 9115 833 833</a>, email us at <a
                                                                            href="mailto:voydinteriors@gmail.com"
                                                                            target="_blank">voydinteriors@gmail.com</a>,
                                                                        or visit our website <a
                                                                            href="https://mrinterior.mmworkspace.com/"
                                                                            target="_blank">www.voydinteriors.com</a>.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
    ...
    $mail->AltBody = 'Refer a Friend';

    $send = $mail->send();

    if ($send) {
        $stat = ['status' => true, 'message' => "Thank you for the referral, we have emailed"];
    }
} catch (Exception $e) {
