...
include "./freezeMailTemplate.php";
...
$getCustomerInfo = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM customer WHERE customer_id  = '$id' AND status = 1"));
$firstName = $getCustomerInfo['first_name'];
$lastName = $getCustomerInfo['last_name'];
// $query = mysqli_query($conn, "SELECT * FROM questionnaire tbl1, quotation tbl2 WHERE tbl1.que_id=tbl2.'" . $queId . "' AND tbl1.customer_id='" . $id . "' AND tbl1.status=1 AND tbl2.status=1");
// $fet = mysqli_fetch_array($query);
// $name = $fet['first_name'] . $fet['last_name'];
// $ProjectName = "Mr.INTRO0" . $fet['customer_id'] . "-" . $fet['property'] . $fet['property_type'] . "-" . $fet['que_id'];
// $class = $fet['manufacturer_classification'];

$update_status = mysqli_query($conn, "UPDATE questionnaire tbl1, quotation tbl2  SET tbl1.freeze ='freezed' WHERE tbl1.que_id = '" . $queId . "' && tbl2.que_id='" . $queId . "' && tbl1.customer_id = '" . $id . "' && tbl1.status = 1 && tbl2.status=1");


$quoteData = mysqli_query($conn, "SELECT * FROM questionnaire tbl1, quotation tbl2 WHERE tbl1.que_id=tbl2.que_id AND tbl1.customer_id='" . $id . "' AND tbl1.status=1 AND tbl2.status=1 AND tbl1.que_id = '" . $queId . "'");
$fetchQuoteData = mysqli_fetch_array($quoteData);
$freezeStatus = $fetchQuoteData['freeze'];
...
if ($update_status) {
    ...
    // $path="./Uploads/aboutus/invoice.pdf";
    ...
    try {
        ...
        $mail->addAddress('lovaseshagiri9@gmail.com');               //Name is optional
        $mail->addAddress('Sripriyaa@allyted.com');               //Name is optional
        // $mail->addAddress($email);        

        //Name is optional
        $mail->isHTML(true);                                  //Set email format to HTML
        $mail->Subject = 'Quotation Invoice';
        $mail->Body = '
        <!DOCTYPE html
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width:600px) {
            ...
            *[class="gmail-fix"] {
            ...
            .es-text-1448 .es-text-mobile-size-18.es-override-size,
            .es-text-1448 .es-text-mobile-size-18.es-override-size * {
                font-size: 18px !important;
                line-height: 150% !important
            }
...
<body class="body"
    ...
    <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#F6F6F6">
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:0;Margin:0;width:560px">
                                                        <table cellpadding="0" cellspacing="0" role="presentation"
                                                            ...
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr>
                                                                <td align="left" class="es-text-1448 es-m-p5b"
                                                                    style="padding:0;Margin:0;padding-bottom:15px">
                                                                    <h5 class="es-text-mobile-size-18 es-override-size"
                                                                        style="Margin:0;font-family:arial, helvetica
                                                                        neue, helvetica,
                                                                        sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#333333">
                                                                        <strong>Hi ' . $firstName . ' ' . $lastName .
            '</strong>
                                                                    </h5>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        Thank you for showing your interest in VOYD
                                                                        Interiors.</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 
                                                                        helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        We truly value your time and attention.</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 
                                                                        helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Our team is dedicated to creating spaces that
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" role="presentation"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-text-1448 es-m-p5b"
                                                                    ...
                                                                    <h6
                                                                        style="Margin:0;font-family:arial, helvetica neue, helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:16px;font-style:normal;font-weight:normal;line-height:19.2px;color:#384860">
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        services. Kindly review the attached PDF
                                                                        quotation for your interior design
                                                                        project, outlining estimated costs clearly for
                                                                        your planning convenience.</p>
        ...
        $mail->AltBody = 'Quotation Invoice';
        ...
        if ($send) {
            $response = ["status" => true, "response" => "status updated and mail sent successfully", "freezeStatus" => $freezeStatus];
        }
    } catch (Exception $e) {
        echo 'failed', $e, 'failed';
    }
} else {
    $response = ["status" => false, "reponse" => "Failed to updated"];
}
