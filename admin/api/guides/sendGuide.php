...
$name = $data->leadGeneration->customerName;
$email = $data->leadGeneration->email;
$mobile = $data->leadGeneration->mobile;
$pdf = $data->guidePdf;

$uploadDir = realpath(__DIR__ . '/../../Uploads/guides/');
$pdfFile = trim($data->guidePdf);
$fullPdfPath = $uploadDir . DIRECTORY_SEPARATOR . $pdfFile;

if (!is_file($fullPdfPath)) {
    echo json_encode(["status" => false, "message" => "PDF file not found at: $fullPdfPath"]);
    exit;
}
...
//     <p>Thank you for your interest in VOYD Interiors.</p>
//     <p>Please find your guide PDF attached.</p>
//     <p>Regards,<br>VOYD Interiors</p>
// ";
...
<body class="body"
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:0;Margin:0;width:560px">
                                                        <table cellspacing="0" role="presentation" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-p5t"
                                                                    style="padding:0;Margin:0;padding-top:10px">
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 
                                                                        helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Please find your requested guide PDF attached
                                                                        for your reference. </p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 
                                                                        helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        We hope you find the insights helpful and
                                                                        inspiring. </p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 
                                                                        helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Our aim is to provide you with clear ideas and
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        We look forward to assisting you further on your
                                                                        journey. </p>
                                                                </td>
                                                            </tr> -->
                                                            <tr>
    ...
    $generateLead = mysqli_query($conn, "INSERT INTO leads SET name='" . $name . "', email='" . $email . "', number='" . $mobile . "',query_through = 'guides', status=1");
    ...
    echo json_encode(["status" => false, "message" => "Mail could not be sent. Error: " . $mail->ErrorInfo]);
}
