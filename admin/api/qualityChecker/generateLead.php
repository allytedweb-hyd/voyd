...
include "./qualityCheckReportTemplate.php";
...
$location = $data->leadGeneration->area;
$report = $data->report;

$generate_lead = mysqli_query($conn, "INSERT INTO leads SET name='" . $name . "', email='" . $email . "', number='" . $mobile . "', location='" . $location . "', query_through = 'quality', status=1");
...
if (!isset($data->leadGeneration, $data->report)) {
    echo json_encode(["status" => false, "message" => "Invalid data format"]);
    exit;
}

// Generate HTML
$html = generateQualityCheckReport($report);
...
<head>
    ...
    <title>Quality Checker Report</title>
    <style type="text/css">
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        Thank you for your submission of the Quality
                                                                        Report. We sincerely appreciate the effort and
                                                                        attention to detail you have
                                                                        put into preparing and sharing this with us.
                                                                        Your contribution plays an important role in
                                                                        maintaining our standards and
                                                                        ensuring continuous improvement.</p>
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-p5t"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica,
                                                                        sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Please find your quality check report attached
                                                                        for your review and reference. This document
                                                                        provides a detailed overview
                                                                        of the observations, findings, and
                                                                        recommendations based on the assessment
                                                                        conducted.</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;padding-top: 5px;">
...
try {
    ...
    $mail->addAddress('harisangani844@gmail.com');
    $mail->isHTML(true);
    $mail->Subject = 'Quality Check Report';
    $mail->Body = $emailBody;

    $mail->addStringAttachment($pdf, $filename); // Attach PDF with correct name
