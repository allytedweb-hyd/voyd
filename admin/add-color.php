            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./color.php">View Colors
                        </li></a>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Add Color</h3>
                        <form class="row form_new" method="post" enctype="multipart/form-data">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="color" id="colorcode" placeholder="Enter Color Code(#f9f2fc)" value="<?php echo isset($_POST['color']) ? htmlspecialchars($_POST['color']) : ''; ?>">
                                <p id="errText" class="error-text"></p>
                            </div>
                            <div class="col-md-12">
                                <label for="input1" class="form-label"> Color Shade<span class="errorindicator">*</span></label>
                                <input type="text" class="form-control" name="colorShade" id="colorShade" placeholder="Enter Color Shade" value="<?php echo isset($_POST['colorShade']) ? htmlspecialchars($_POST['colorShade']) : ''; ?>">
                                <p id="errText" class="error-text"></p>
                            </div>
...
$(document).ready(function () {
    ...
    capitalizeFirstLetter("colorShade");
