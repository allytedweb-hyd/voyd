            ...
            <div class="">
                ...
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Customers</h3>
                        <div class="row" style="padding: 0px 10px;">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from customer where status=1 ORDER BY customer_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="email-cell" ><?php echo $fetch['customer_email']; ?></td>
                                                ...
                                                <td class="actionbuttons">
                                                    <a class="idelete" href="./delete-customer.php?id=<?php echo $fetch['customer_id']; ?>"><i class='bx bx-trash' name="deleteContact"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
