            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Add Property Type</h3>
                        <form class="row form_new" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="propertyType" id="propertype" value="<?php echo isset($_POST['propertyType']) ? htmlspecialchars($_POST['propertyType']) : ''; ?>">
                                <p id="errText" class="error-text"></p>
                            </div>
...
$(document).ready(function () {
    ...
    capitalizeFirstLetter("propertype");
