            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-googlereviews.php">Add Google Reviews</li></a>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="">
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Google Reviews</h3>
                        <div class="row" style="padding: 0px 10px;">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from google_reviews where status=1 ORDER BY review_id DESC");
                                        $i = 1;
...
?>
                                                ...
                                                <!-- <?php echo $fetch['review_name']; ?> -->

                                                    <div class="tooltip-text"
                                                 data-toggle="tooltip" data-placement="bottom"
                                                    title="<?php echo htmlspecialchars(ucwords(strip_tags($fetch['review_name']))); ?>">
                                                    <?php echo htmlspecialchars(strip_tags($fetch['review_name'])); ?>
                                                </div>
                                            
                                            </td>
                                               
                                                <td><img class="imagedata" src='Uploads/googlereviews/<?php echo $fetch['image']; ?>' /></td>
    ...
    <div class="tooltip-text" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        <?= htmlspecialchars(mb_strimwidth($cleanDesc, 0, 50, '...')) ?> 
                                                ...
                                                <td class="actionbuttons"><a class="iedit" href="./edit-googlereviews.php?id=<?php echo $fetch['review_id']; ?>"> <i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-googlereviews.php?id=<?php echo $fetch['review_id']; ?>"><i class='bx bx-trash' name="deleteTestimonial"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
