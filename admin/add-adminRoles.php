            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Add Roles</h3>
                        <form class="row form_new" id="submitForm" method="post" enctype="multipart/form-data" name="myform"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="role" id="empRole" value="<?php echo isset($_POST['role']) ? htmlspecialchars($_POST['role']) : ''; ?>">
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    ...
                                    <button name="submit_role" type="submit" id="submit-role"
