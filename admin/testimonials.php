...
<div class="page-wrapper">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-testimonials.php">Add Testimonials</li></a>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="">
                <div class="">
                    <div class="card-body new_card">
                        <h3 class="mb-4 text-center htext">View Testimonials</h3>
                        <div class="row" style="padding: 0px 10px;">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from testimonials where status=1 ORDER BY testimonial_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="imgtd" ><img class="imagedata"  src='Uploads/testimonials/<?php echo $fetch['testimonial_image']; ?>' /></td>
                                                <td><?php echo $fetch['testimonial_alttext']; ?></td>
                                                <td>

                                              

                                                <?php
        $rawDesc = $fetch['testimonial_description'] ?? '';
    ...
    <div class="tooltip-text" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        <?= htmlspecialchars(mb_strimwidth($cleanDesc, 0, 50, '...')) ?> 
                                                ...
                                                <td class="actionbuttons"><a class="iedit" href="./edit-testimonial.php?id=<?php echo $fetch['testimonial_id']; ?>"> <i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-testimonial.php?id=<?php echo $fetch['testimonial_id']; ?>"><i class='bx bx-trash' name="deleteTestimonial"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
