...
// echo "Session admin ID: " . $_SESSION['admin_id'];
...
if (isset($_GET['filter'])) {
    ...
    if ($filter ==  "" || $filter == "All") {
        $MCquery = mysqli_query($conn, "SELECT * FROM questionnaire T1, quotation T2 WHERE T1.que_id = T2.que_id AND T2.manager_id='$_SESSION[admin_id]' AND T1.status=1");
        $i = 1;
...
?>
    ...
    <div class="tooltip-text" data-toggle="tooltip" data-placement="bottom" title="<?= $escapedDesc ?>">
        ...
        $Mquery = mysqli_query($conn, "SELECT * FROM questionnaire T1, quotation T2 WHERE T1.que_id = T2.que_id AND T1.freeze='freezed' AND T2.manager_id='$_SESSION[admin_id]' AND T1.status=1");
