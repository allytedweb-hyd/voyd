            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./statusMasters.php">View
                                Status Masters</li>
                        </a>
                    </ol>
                </nav>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Add Status Master</h3>
                        <form class="row form_new" id="submitForm" method="post" enctype="multipart/form-data" name="myform" id="myform">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="status" id="projectStatus" value="<?php echo isset($_POST['status']) ? htmlspecialchars($_POST['status']) : ''; ?>">
                                <p id="errText" class="error-text"></p>
                            </div>
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="button" id="addStatus" class="btn btn-primary px-4 submit">Submit</button>
                                    <button name="submit_status" type="submit" id="submitStatus" class="btn btn-primary px-4 submit d-none">Submit</button>
                                </div>
                            </div>
