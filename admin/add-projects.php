...
if (isset($_POST['submit_form'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        $targetPath = 'Uploads/projects/' . $filename;
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        rumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="" ><a href="./projects.php">View Projects
                        </li></a>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Add Projects</h3>
                        <form class="row form_new" method="post" enctype="multipart/form-data">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="title" id="prevProjectTitle" value="<?php echo isset($_POST['title']) ? htmlspecialchars($_POST['title']) : ''; ?>">
...
<?php if (!empty($_POST['oldImage'])): ?>
    <div style="margin-top: 2px;">
        <img src="Uploads/projects/<?php echo htmlspecialchars($_POST['oldImage']); ?>" alt="Uploaded Image" width="80">
    </div>
<?php endif; ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="projectdesc" name="description"><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                                <p id="errText" class="error-text"></p>
                            </div>
...
$(document).ready(function () {
    ...
    capitalizeFirstLetter("prevProjectTitle");
