            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-status.php">Add Status
                                Master</li></a>
                    </ol>
                </nav>
            </div>
                        ...
                        <div class="row" style="padding: 0px 10px;">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "SELECT * FROM tbl_status_master WHERE status=1 ORDER BY status_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr >
                                                ...
                                                <td><?php echo $fetch['status_master']; ?></td>
                                                <td><?php echo $fetch['created_by']; ?></td>
                                                <td><?php echo $fetch['created_date']; ?></td>
                                                <td><?php echo $fetch['updated_date']; ?></td>
                                                <td class="actionbuttons"><a class="iedit" href="./editStatusMaster.php?id=<?php echo $fetch['status_id']; ?>"><i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-subcategory.php?id=<?php echo $fetch['status_id']; ?>"><i class='bx bx-trash' name="deleteProject"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
