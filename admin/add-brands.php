...
if(isset($_POST['submit_form']))
{
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        $targetPath = 'Uploads/brands/' . $filename;
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./brands.php">View Brands
                        </li></a>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        ...
                        <form class="row form_new" id="submitForm" name="submitForm" method="post"
...
<?php if (!empty($_POST['oldImage'])): ?>
    <div style="margin-top: 2px;">
        <img src="Uploads/brands/<?php echo htmlspecialchars($_POST['oldImage']); ?>" alt="Uploaded Image" width="80">
    </div>
<?php endif; ?>
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="button" id="add-brands"
                                        class="btn btn-primary px-4 submit">Submit</button>
                                    <button name="submit_form" type="submit" id="submit-brands"
...
<script src="./assets/api/brandapi.js"></script>
