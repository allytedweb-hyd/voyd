            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-manuCategory.php">Add Category</li></a>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <table class="table table-striped table-bordered" id="example2">
                                    <thead>
                                        <tr class="tableheadingrow">
                                            ...
                                            <th scope=" col">Select Product Type</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from manufacturer_category where status=1 ORDER BY mcategory_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="actionbuttons"><a class="iedit" href="./edit-manuCategory.php?id=<?php echo $fetch['mcategory_id']; ?>"><i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-manuCategory.php?id=<?php echo $fetch['mcategory_id']; ?>"><i class='bx bx-trash' name="deleteProject"></i></a>
                                                </td>
