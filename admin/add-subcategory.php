...
if (isset($_POST['submit_form'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        $targetPath = 'Uploads/subcategory/' . $filename;
                    ...
                    <div class="card-body new_card_form">
                        ...
                        <form class="row form_new" method="post" enctype="multipart/form-data" id="myform" name="myform">
                            <div class="col-md-12">
                                ...
                                <select class="form-select" name="category" size="1" id="pcategory">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="subcategory" id="psubcategory" value="<?php echo isset($_POST['subcategory']) ? htmlspecialchars($_POST['subcategory']) : ''; ?>">
                                <p id="errText" class="error-text"></p>
                            </div>
...
<?php if (!empty($_POST['oldImage'])): ?>
    <div style="margin-top: 2px;">
        <img src="Uploads/subcategory/<?php echo htmlspecialchars($_POST['oldImage']); ?>" alt="Uploaded Image" width="80">
    </div>
<?php endif; ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="alttext" id="pcategoryAlttext" value="<?php echo isset($_POST['alttext']) ? htmlspecialchars($_POST['alttext']) : ''; ?>">
                                <p id="errText" class="error-text"></p>
                            </div>

                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="button" id="add-psubcategory"
                                        class="btn btn-primary px-4 submit">Submit</button>
                                    <button name="submit_form" type="submit" id="submit-psubcategory"
...
$(document).ready(function () {
    ...
    capitalizeFirstLetter("psubcategory");
    capitalizeFirstLetter("pcategoryAlttext");
