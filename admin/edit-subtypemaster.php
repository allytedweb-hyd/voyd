            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./subtypemaster.php">View Sub Type </li></a>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-xl-6 mx-auto">
                ...
                <div class="">
                    <div class="card-body new_card_form">
                        <h3 class="mb-4 text-center htext">Update Sub Type </h3>

                        <?php
                        $query = mysqli_query($conn, "select * from subtype_master where 
                        subtype_id='" . $_GET['id'] . "'");
...
<?php
        ...
        ?>
                              ...
                              <div class="col-md-12">
                                ...
                                <!-- <option value="<?php echo $fetch['product_type'] ?></option>">
...
<option value="<?php echo $fetch['product_type']; ?>"><?php echo $fetch['product_type']; ?></option>

<?php

$querytestimonial = mysqli_query($conn, "SELECT * FROM product_type_master WHERE status=1 AND product_type != '" . $fetch['product_type'] . "'");


while ($fetchTestimonials = mysqli_fetch_array($querytestimonial)) {
?>
    <option value="<?php echo $fetchTestimonials['product_type']; ?>">
        <?php echo $fetchTestimonials['product_type']; ?>
    </option>
<?php
}
?>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="subtype" id="subtype" value="<?php echo $fetch['sub_type'] ?>">
                                <input type="hidden" name="materialId" value="<?php echo $fetch['subtype_id'] ?>" />
                                <p id="errText" class="error-text"></p>
                            </div>
                             ...
                             <!-- <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="recommend" id="recommend" value="<?php echo $fetch['recommend'] ?>">
                                <p id="errText" class="error-text"></p>
                            </div>

                             <div class="col-md-12">
                                <label for="input1" class="form-label"> Strongly Recommend</label>
                                <input type="text" class="form-control" name="strongly_recommend" id="strongly_recommend" value="<?php echo $fetch['strongly_recommend'] ?>">
                                <p id="errText" class="error-text"></p>
                            </div> -->
                             ...
                             <div class="col-md-12">
                                <label for="input1" class="form-label">  Priority<span class="errorindicator">*</span> </label>
                                  ...
                                  <select class="form-select" name="recommend" id="recommend">
                                    <!-- <option value="<?php echo $fetch['recommend'] ?>"><?php echo $fetch['recommend'] ?></option>
