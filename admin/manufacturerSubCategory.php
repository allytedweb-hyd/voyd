            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="./add-manuSubcategory.php">Add Sub Category</li></a>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="row" style="padding: 0px 10px;">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sel = mysqli_query($conn, "select * from manufacturer_subCategory where status=1 ORDER BY mSubcategory_id DESC");
                                        $i = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $fetch['sub_category']; ?></td>
                                                <td><?php echo $fetch['updated_by']; ?></td>
                                                <td><?php echo $fetch['updated_At']; ?></td>
                                                <td class="actionbuttons"><a class="iedit" href="./edit-manuSubcategory.php?id=<?php echo $fetch['mSubcategory_id']; ?>"><i class='bx bx-edit'></i></a>
                                                    <a class="idelete" href="./delete-manuSubcategory.php?id=<?php echo $fetch['mSubcategory_id']; ?>"><i class='bx bx-trash' name="deleteProject"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i++;
                                        } ?>
